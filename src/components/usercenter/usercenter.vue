    ...
    <div>
      <header>
        <div class="header-content">
          ...
          <a href="javascript:;" class="editcart">设置</a>
        </div>
      </header>
    ...
    ul
      ...
      li
        ...
        a
          ...
          .item-ico
            display inline-block
            span#ico1, span#ico2, span#ico4, span#ico5
              display: inline-block
              height: 3rem
              width: 3.5rem
